                ...
                <div class="inventory__content-left" :class="{'active': menuBlock}">
                    <div class="menu">
                        <div class="menu-close" @click="menuBlockClose">
                         ...
                         <p class="media-p" v-if="type1 || type2 || type3 || type4 || type5 || type6 || type7 || korobTrue || korobFalse || priceChange[0] > 1000 || priceChange[1] < 100000 || yearChange[0] > 1990 || yearChange[1] < 2023 || kmChange < 500000 || selectedCar || findCar" @click="clearFilters">Clear filters</p>
                    </div>
                    ...
                    <div class="accordeons">
                        <div class="accordeon-item" ref="accordionOne">
                              ...
                              <div class="search-input">
                                ...
                                <div class="input">
                                    ...
                                    <div class="input-search-one" :class="{'active': openTwoTab}" v-if="selectedCar">
                                        <p v-for="(car, idx) in filtredModel" :key="idx" @click="handleClickTwo(car)">{{car}}</p>
                            ...
                            <div class="label-cars" v-if="selectedCar">
                                <div class="label" v-if="selectedCar">
                                    <img @click="closeSorted" src="../assets/images/inventory/icons/closet.svg" alt="">
                                    <p>{{selectedCar}}</p>
                                </div>
                                <div class="label" v-if="selectedModel">
                                    <img @click="selectedModel = null" src="../assets/images/inventory/icons/closet.svg" alt="">
                                    <p>{{selectedModel}}</p>
                                </div>
                            </div>
                        </div>
...
export default{
    ...
    filteredCars() {
        ...
        filtredModel(){
            ...
            return this.modelCar[this.selectedCar].filter(model => model.toLowerCase().includes(this.searchModel.toLowerCase()));
            },   
